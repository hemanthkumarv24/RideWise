...
//                     <img src={image1} alt="image1"  height={300} width={500}/>
//                     <p>Book your next cab at cheapest price Save upto 50% on long distance & Airport rides</p>
//                     <br />
//                     <img src={image2} alt="image1"  height={300} width={500}/>
//                     <p>Find more ride hail options that you didn't know existed</p>
//                 </Col>
//                 <Col className="col" xs={24} md={12} sm={24} lg={12} xl={12}>
//                 <img src={image3} alt="image1"  height={300} width={500}/>
//                 <p>Just one app to find the best ride across cab services Reduce the app clutter in your mobile</p>
//                 <br />
//                 <img src={image4} alt="image1"  height={300} width={500}/>
//                 <p>Compare cab prices to save time and money on every ride, upto Rs 5000 every month !</p>
